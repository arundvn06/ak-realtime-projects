...
def get_similarity(image1, image2):
    ...
    myModel = Siamese()
    ckpt = torch.load('/home/b22/b22h4g12/Hackathon-setup/siamese_model.t7',map_location=device)
    myModel.load_state_dict(ckpt['net_dict'])
    # YOUR CODE HERE, return similarity measure using your model
    output1,output2 = myModel(face1,face2) #using the loaded 'myModel'; even 'net' can be used
